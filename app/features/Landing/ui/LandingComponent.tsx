...
export default function LandingComponent() {
    return (
        <section className='font-sans flex justify-center items-center h-screen'>
            <article className='flex flex-col md:flex-row gap-16 items-start justify-center my-16 md:mx-16 px-2'>
                <div className='w-full md:w-1/2 flex flex-col gap-3'>
                    ...
                    <span className='text-gray-600 text-2xl font-semibold mt-3'>Unete y colabora con miembros de tu comunidad  en actividades de bienestar comunitario</span>
